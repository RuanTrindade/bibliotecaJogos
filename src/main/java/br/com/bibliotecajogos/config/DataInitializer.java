...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (categoriaRepository.count() == 0) {
            ...
            // Criar Estúdios
            Estudio cdProjekt = new Estudio(); cdProjekt.setNome("CD Projekt Red");
            Estudio rockstar = new Estudio(); rockstar.setNome("Rockstar Games");
            Estudio relic = new Estudio(); relic.setNome("Relic Entertainment");
            Estudio larian = new Estudio(); larian.setNome("Larian Studios");
            Estudio santaMonica = new Estudio(); santaMonica.setNome("Santa Monica Studio");
            Estudio fromSoftware = new Estudio(); fromSoftware.setNome("FromSoftware");
            Estudio blizzard = new Estudio(); blizzard.setNome("Blizzard Entertainment");
            Estudio nintendo = new Estudio(); nintendo.setNome("Nintendo");
            estudioRepository.saveAll(Arrays.asList(cdProjekt, rockstar, relic, larian, santaMonica, fromSoftware, blizzard, nintendo));
